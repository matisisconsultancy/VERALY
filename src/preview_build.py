...
(function(){
  ...
  function initScramble(){[].slice.call(document.querySelectorAll('.eyebrow, .eyebrow-num, .faq-pill, .bfilter-pill, .article-kicker')).forEach(function(el){if(el.__scr)return;el.__scr=1;if(scrIO)scrIO.observe(el);else scrambleText(el);});}
